import numpy as np
from bfm.bfm50.Functions.seasonal_cycling_functions import get_wind, get_salinity, get_sunlight, get_temperature
...
def bfm50_rate_eqns(iter, time, d3state, bfm_phys_vars, seasonal_cycle=False):
