import numpy as np
from reduction.reduce_bfm.Functions.seasonal_cycling_functions import get_wind, get_salinity, get_sunlight, get_temperature, calculate_density
from reduction.reduce_bfm.Functions.phyto import phyto_eqns
from reduction.reduce_bfm.Functions.bacteria import bacteria_eqns
from reduction.reduce_bfm.Functions.predation import get_mesozoo_predation_terms, get_microzoo_predation_terms
from reduction.reduce_bfm.Functions.micro import microzoo_eqns
from reduction.reduce_bfm.Functions.meso import mesozoo_eqns
from reduction.reduce_bfm.Functions.pel_chem import pel_chem_eqns
from reduction.reduce_bfm.Functions.oxygen import calculate_oxygen_reaeration
from reduction.reduce_bfm.Functions.co2_flux_functions import calculate_co2_flux
from reduction.reduce_bfm.Functions.other_functions import insw_vector, get_concentration_ratio
