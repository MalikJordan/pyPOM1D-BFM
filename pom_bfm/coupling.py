...
def pom_bfm_1d(i, vertical_grid, time, diffusion, nutrients, bfm_phys_vars, d3state, d3stateb, d3ave, multiplier):
    """
    ...
    bfm_rates, bfm_phys_vars, dOdt_wind, do3cdt_air_sea_flux, chl, npp = bfm50_rate_eqns(i, time, d3state, bfm_phys_vars, multiplier, seasonal_cycle=False)
